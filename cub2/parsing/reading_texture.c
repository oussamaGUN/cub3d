...
/*   Updated: 2024/07/01 15:44:34 by oussama          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	parse_texture_part_one(char **texture, t_mlx *mlx_data)
{
	...
	{
		if (mlx_data->map_info.NO || !texture[1] || !ft_strcmp(texture[1], "\n"))
	...
	{
		if (mlx_data->map_info.SO || !texture[1] || !ft_strcmp(texture[1], "\n"))
...
int	parst_texture_part_two(char **texture, t_mlx *mlx_data)
{
	...
	{
		if (mlx_data->map_info.WE || !texture[1] || !ft_strcmp(texture[1], "\n"))
	...
	{
		if (mlx_data->map_info.EA || !texture[1] || !ft_strcmp(texture[1], "\n"))
